# Doctor-s-Portal
It is a project which is made for convenience for doctors as well as patients to book an appointment
...
Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/doct/.
